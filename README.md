...
| **颜色与样式** | RGB/RGBA、渐变色、描边/填充、描边对齐、混合模式 |
...
<div align="center">
  <img src="examples/09-projects/06_christmas_avatar/06_christmas_avatar.png" width="400" alt="圣诞头像">
</div>
