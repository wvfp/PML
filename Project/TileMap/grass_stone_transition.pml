; grass_stone_transition.pml — 草地→石头过渡瓦片
; 顶面草地shader，侧面使用石头颜色

(provide draw-grass-stone-transition)
...
; ═══════════════════════════════════════════════════════════════════════════════
; 左侧面: 石头色 (与 stone_lib 一致: #3A3530)
; ═══════════════════════════════════════════════════════════════════════════════

(define (left-face-stone-color cx cy w h d)
  (define ax (- cx (/ w 2)))
  (define ay cy)
  (define bx cx)
  (define by (+ cy (/ h 2)))
...
; ═══════════════════════════════════════════════════════════════════════════════
; 右侧面: 石头色偏暗 (与 stone_lib 一致: #2A2520)
; ═══════════════════════════════════════════════════════════════════════════════

(define (right-face-stone-color cx cy w h d)
  (define ax (+ cx (/ w 2)))
  (define ay cy)
  (define bx cx)
  (define by (+ cy (/ h 2)))
...
(define (draw-grass-stone-transition cx cy tw th td shader)
  (group
    (left-face-stone-color cx cy tw th td)
    (right-face-stone-color cx cy tw th td)
